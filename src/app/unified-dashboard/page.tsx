  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex flex-1">
        ...
        <div className="fixed left-0 top-16 bottom-0 w-64 bg-white border-r border-gray-200 z-40 flex flex-col hidden lg:flex">
          {/* Sidebar Header */}
        ...
        <div className="lg:ml-64 flex-1 pt-16 lg:pt-0">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full h-full">
            ...
            <div className="p-6">
              ...
              {/* Add all other TabsContent elements here... */}
      ...
      <div className="lg:hidden">
        {/* Mobile Top Bar */}
        <div className="fixed top-16 left-0 right-0 z-50 bg-white border-b border-gray-200">
        ...
        {mobileMenuOpen && (
          <>
            ...
            {/* Sidebar */}
            <div className="fixed left-0 top-16 bottom-0 w-64 bg-white z-50 flex flex-col">
